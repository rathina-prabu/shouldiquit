...
export const QUESTIONS: Question[] = [
  // Module 1: THE WORK (3 questions)
  {
    ...
    choices: [
      ...
      { label: "Pure execution of someone else's blueprint. No thinking.", highlight: "Pure execution", scores: { work: -1, cynicism: 3 } },
    ],
  },
  {
    id: "q2", module: "work",
    ...
    choices: [
      ...
      { label: "Going backwards, losing edges you had when you joined.", highlight: "Going backwards", scores: { work: -1, cynicism: 3, intent_to_quit: 3 } },
    ],
  },
  {
    id: "q3", module: "work",
    ...
    choices: [
      ...
      { label: "Honestly, nobody.", highlight: "Honestly, nobody", scores: { work: -1, cynicism: 3 } },
    ],
  },
  ...
  },
  {
    ...
    choices: [
      ...
      { label: "\"Be more proactive.\" \"Create visibility.\" Same words, every year.", highlight: "Same words, every year", scores: { manager: -1, cynicism: 4 } },
    ],
  },
  {
  ...
  // Module 3: THE PEOPLE (4 questions)
  {
    ...
    choices: [
      ...
      { label: "Pretty sure there's a team WhatsApp without you in it.", highlight: "WhatsApp without you", scores: { people: -1, cynicism: 3 } },
    ],
  },
  {
    id: "q9", module: "people",
  ...
  },
  {
    ...
    choices: [
      ...
      { label: "Nobody here is worth learning from. ChatGPT is your mentor.", highlight: "ChatGPT is your mentor", scores: { people: -1, growth: 0, cynicism: 4, intent_to_quit: 2 } },
    ],
  },
  {
    ...
    choices: [
      ...
      { label: "They take leadership's side. Every time.", highlight: "leadership's side", scores: { people: -1, cynicism: 3 } },
    ],
  },
  ...
  },
  {
    ...
    choices: [
      ...
      { label: "Anything you say gets shot down. So you stopped speaking up.", highlight: "stopped speaking up", scores: { growth: -1, cynicism: 4, agency: -2 } },
    ],
  },
  {
    ...
    choices: [
      ...
      { label: "Work bleeds into evenings often. Weekends sometimes too.", highlight: "Work bleeds into evenings", scores: { growth: -1, wellbeing: -1, cynicism: 2 } },
