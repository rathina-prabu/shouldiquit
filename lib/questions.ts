...
export const QUESTIONS: Question[] = [
  // Module 1: THE WORK (3 questions)
  {
    ...
    choices: [
      ...
      { label: "Directionless. You do work, no one's quite sure why.", highlight: "Directionless", scores: { work: 0, cynicism: 2 } },
      { label: "Pure execution of someone else's blueprint. No thinking.", highlight: "Pure execution", scores: { work: -2, cynicism: 3 } },
    ],
  },
  {
    id: "q2", module: "work",
    ...
    choices: [
      ...
      { label: "Plateaued. No real skill movement in a while.", highlight: "Plateaued", scores: { work: 0, cynicism: 2 } },
      { label: "Going backwards, losing edges you had when you joined.", highlight: "Going backwards", scores: { work: -2, cynicism: 3, intent_to_quit: 3 } },
    ],
  },
  {
    id: "q3", module: "work",
    ...
    choices: [
      ...
      { label: "Leadership / the wider org.", highlight: "Leadership", scores: { work: 3 } },
      { label: "Just my manager.", highlight: "Just my manager", scores: { work: 0 } },
      { label: "Honestly, nobody.", highlight: "Honestly, nobody", scores: { work: -2, cynicism: 3 } },
    ],
  },
  // Module 2: THE MANAGER (4 questions)
  {
    ...
    choices: [
      ...
      { label: "Quiet relief. The day just got easier.", highlight: "Quiet relief", scores: { manager: 0, cynicism: 2 } },
      { label: "Praying it's a broken leg. Both ideally.", highlight: "broken leg. Both ideally", scores: { manager: -2, cynicism: 3, intent_to_quit: 2 } },
    ],
  },
  {
    ...
    choices: [
      ...
      { label: "Slacks at 10pm but writes \"no rush\" and means it.", highlight: "\"no rush\" and means it", scores: { manager: 3 } },
      { label: "Pings whenever. Expects replies fast.", highlight: "Pings whenever", scores: { manager: 0, intent_to_quit: 1 } },
      { label: "Phone calls. At 11pm. On a Sunday. About something that could've waited.", highlight: "11pm. On a Sunday", scores: { manager: -2, intent_to_quit: 3 } },
    ],
  },
  {
    ...
    choices: [
      ...
      { label: "Silent when it works. Loud when something breaks.", highlight: "Loud when something breaks", scores: { manager: 0, cynicism: 2 } },
      { label: "\"Be more proactive.\" \"Create visibility.\" Same words, every year.", highlight: "Same words, every year", scores: { manager: -2, cynicism: 4 } },
    ],
  },
  {
    ...
    choices: [
      ...
      { label: "Mentioned when relevant. Fair share.", highlight: "Fair share", scores: { manager: 3 } },
      { label: "\"The team did great work.\" Your specific bit, invisible.", highlight: "Your specific bit, invisible", scores: { manager: 0, cynicism: 2 } },
      { label: "They take it. Personally. Like you weren't even in the room.", highlight: "They take it. Personally", scores: { manager: -2, cynicism: 4, intent_to_quit: 3 } },
    ],
  },
  // Module 3: THE PEOPLE (4 questions)
  {
    ...
    choices: [
      ...
      { label: "One real one. Your work-survival lifeline. Mostly at work though.", highlight: "One real one", scores: { people: 3 } },
      { label: "Friendly with everyone. Close to no one.", highlight: "Close to no one", scores: { people: 0 } },
      { label: "Pretty sure there's a team WhatsApp without you in it.", highlight: "WhatsApp without you", scores: { people: -2, cynicism: 3 } },
    ],
  },
  {
    id: "q9", module: "people",
    ...
    choices: [
      ...
      { label: "Active warzone. Half your energy goes to surviving it.", highlight: "Active warzone", scores: { people: 0, intent_to_quit: 2 } },
      { label: "Every resignation story here starts with the politics.", highlight: "Every resignation story", scores: { people: -2, cynicism: 4, intent_to_quit: 4 } },
    ],
  },
  {
    ...
    choices: [
      ...
      { label: "The senior who said \"reach out anytime\" has never replied.", highlight: "never replied", scores: { people: 0, growth: 1, cynicism: 2 } },
      { label: "Nobody here is worth learning from. ChatGPT is your mentor.", highlight: "ChatGPT is your mentor", scores: { people: -2, growth: 0, cynicism: 4, intent_to_quit: 2 } },
    ],
  },
  {
    ...
    choices: [
      { label: "Genuinely on your side. They've fought for you behind the scenes.", highlight: "Genuinely on your side", scores: { people: 5 } },
      { label: "Diwali emails. Engagement surveys. Background noise.", highlight: "Background noise", scores: { people: 3 } },
      { label: "\"Open door policy.\" Nobody home when you knock.", highlight: "Nobody home when you knock", scores: { people: 0, cynicism: 2 } },
      { label: "They take leadership's side. Every time.", highlight: "leadership's side", scores: { people: -2, cynicism: 3 } },
    ],
  },
  // Module 4: THE GROWTH (3 questions)
  {
    ...
    choices: [
      ...
      { label: "\"You need more impact.\" Ask what impact means. Silence.", highlight: "Silence", scores: { growth: 0, cynicism: 3 } },
      { label: "The cycle closed without you. You found out from someone else's promo announcement.", highlight: "cycle closed without you", scores: { growth: -2, cynicism: 4, intent_to_quit: 4 } },
    ],
  },
  {
    ...
    choices: [
      ...
      { label: "Polite nods. Then ignored. You've started noticing the pattern.", highlight: "Polite nods. Then ignored", scores: { growth: 0, cynicism: 2 } },
      { label: "Anything you say gets shot down. So you stopped speaking up.", highlight: "stopped speaking up", scores: { growth: -2, cynicism: 4, agency: -2 } },
    ],
  },
  {
    ...
    choices: [
      ...
      { label: "Work bleeds into evenings often. Weekends sometimes too.", highlight: "Work bleeds into evenings", scores: { growth: 0, wellbeing: 0, cynicism: 2 } },
      { label: "Laptop on every trip. On-call through weddings and weekend getaways.", highlight: "On-call through weddings", scores: { growth: -2, wellbeing: -2, cynicism: 3, intent_to_quit: 3 } },
    ],
  },
  // Module 5: THE MONEY (2 questions)
  {
    ...
    choices: [
      ...
      { label: "Below inflation. You did the math. You're earning less in real terms.", highlight: "Below inflation", scores: { money: 0, cynicism: 2, intent_to_quit: 1 } },
      { label: "Zero hike. \"It's been a tough year for the company.\"", highlight: "Zero hike", scores: { money: -1, cynicism: 4, intent_to_quit: 4 } },
    ],
  },
  {
    id: "q16", module: "money",
  ...
  // Module 6: THE STATE OF YOU / wellbeing (2 questions)
  {
    ...
    choices: [
      ...
      { label: "Mood drops around 7 PM. The week starts arriving.", highlight: "Mood drops", scores: { wellbeing: 0, intent_to_quit: 2 } },
      { label: "Can't sleep. Tomorrow's meetings already running in your head.", highlight: "Can't sleep", scores: { wellbeing: -2, intent_to_quit: 3 } },
    ],
  },
  {
    ...
    choices: [
      ...
      { label: "Even when you're enjoying something, thoughts of work pop in. The mood crashes.", highlight: "thoughts of work pop in", scores: { wellbeing: 0, cynicism: 2 } },
